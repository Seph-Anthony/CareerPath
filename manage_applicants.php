...
if ($stmt) {
    ...
    while ($row = $result->fetch_assoc()) {
        ...
        // Group applicants under their respective post
    ...
    <main class="main-content">
        ...
        <div class="dashboard-body">
            ...
            <?php if (!empty($error_message)): ?>
                <div class="alert error" style="background-color: #f8d7da; color: #721c24; border: 1px solid #f5c6cb; padding: 10px; margin-bottom: 20px; border-radius: 5px;">
                ...
                <?php foreach ($applicant_data as $posting_id => $data): ?>
                    <div class="applicants-card">
                        <div class="card-header">
                            ...
                            <span class="slot-info">Slots Available: <strong><?php echo $data['slot_available']; ?></strong></span>
                        </div>
